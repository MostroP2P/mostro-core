...
* add Action::AddBondInvoice by [@grunch](https://github.com/grunch)

### 💼 Other


* feat(message): add Action::AddBondInvoice by [@grunch](https://github.com/grunch) in [#146](https://github.com/MostroP2P/mostro-core/pull/146)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#146](https://github.com/MostroP2P/mostro-core/pull/146)

**Full Changelog**: https://github.com/MostroP2P/mostro-core/compare/v0.11.1...0.11.2
