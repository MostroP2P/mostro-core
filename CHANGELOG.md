...
## What's Changed in 0.11.5

### 🚀 Features


* add BondSlashed action by [@grunch](https://github.com/grunch)

### 💼 Other


* feat(message): add BondSlashed action by [@grunch](https://github.com/grunch) in [#149](https://github.com/MostroP2P/mostro-core/pull/149)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#149](https://github.com/MostroP2P/mostro-core/pull/149)

**Full Changelog**: https://github.com/MostroP2P/mostro-core/compare/v0.11.4...0.11.5
