...
* ensure rumor id is serialized inside the gift wrap by [@Catrya](https://github.com/Catrya)

### 💼 Other


* fix: ensure rumor id is serialized inside the gift wrap by [@grunch](https://github.com/grunch) in [#164](https://github.com/MostroP2P/mostro-core/pull/164)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#164](https://github.com/MostroP2P/mostro-core/pull/164)
* [@Catrya](https://github.com/Catrya) made their contribution

**Full Changelog**: https://github.com/MostroP2P/mostro-core/compare/v0.14.4...0.14.5
