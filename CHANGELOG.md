...
* use new vote in rating running average instead of previous one by [@grunch](https://github.com/grunch)

### 💼 Other


* fix: rating running average folded in the previous vote instead of the new one by [@grunch](https://github.com/grunch) in [#163](https://github.com/MostroP2P/mostro-core/pull/163)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#163](https://github.com/MostroP2P/mostro-core/pull/163)

**Full Changelog**: https://github.com/MostroP2P/mostro-core/compare/v0.14.3...0.14.4
