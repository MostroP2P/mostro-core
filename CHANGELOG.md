...
* add P2P chat protocol module by [@grunch](https://github.com/grunch)

### 💼 Other


* feat(chat): add P2P chat protocol module by [@grunch](https://github.com/grunch) in [#142](https://github.com/MostroP2P/mostro-core/pull/142)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#142](https://github.com/MostroP2P/mostro-core/pull/142)

**Full Changelog**: https://github.com/MostroP2P/mostro-core/compare/v0.10.0...0.10.1
