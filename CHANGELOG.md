...
* add `CooperativelyCanceled` status by [@grunch](https://github.com/grunch)

### 💼 Other


* feat(dispute): add CooperativelyCanceled status by [@grunch](https://github.com/grunch) in [#173](https://github.com/MostroP2P/mostro-core/pull/173)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#173](https://github.com/MostroP2P/mostro-core/pull/173)

**Full Changelog**: https://github.com/MostroP2P/mostro-core/compare/v0.15.0...0.15.1
