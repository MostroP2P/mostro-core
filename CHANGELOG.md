...
* add CantDoReason::InvalidPayload by [@grunch](https://github.com/grunch)

### 💼 Other


* feat(error): add CantDoReason::InvalidPayload by [@grunch](https://github.com/grunch) in [#145](https://github.com/MostroP2P/mostro-core/pull/145)

## Contributors
* [@grunch](https://github.com/grunch) made their contribution in [#145](https://github.com/MostroP2P/mostro-core/pull/145)

**Full Changelog**: https://github.com/MostroP2P/mostro-core/compare/v0.11.0...0.11.1
